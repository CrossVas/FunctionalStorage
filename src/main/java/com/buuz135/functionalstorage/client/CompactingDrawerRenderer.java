...
public class CompactingDrawerRenderer extends TileEntityRenderer<CompactingDrawerTile> {

    public CompactingDrawerRenderer(TileEntityRendererDispatcher dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(CompactingDrawerTile tile, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
